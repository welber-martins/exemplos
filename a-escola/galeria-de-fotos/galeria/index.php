...
if(isset($_GET['get1']))
{
    ...
    $id = intval(str_replace('a-escola/galeria-de-fotos/galeria/','',$arGet[0]));
    $dbResult = $ponteiro->selectImgsGalerias($id);
}
?>
<!DOCTYPE html>
<html>
        ...
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 240px; width: 720px; height: 480px; overflow: hidden;">
            ...
            if(mysql_num_rows($dbResult) != 0){
                while($dbRow = mysql_fetch_array($dbResult)){
                    ?>
                        <div data-p="150.00">
                            <img data-u="image" src="../../../admin/uploads/r<?php echo $dbRow['foto'] ?>" />
                            <img data-u="thumb" src="../../../admin/uploads/<?php echo $dbRow['foto'] ?>" />
                        </div>
                    <?php
                }
            }
