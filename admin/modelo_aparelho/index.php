                        ...
                        <li>
                            ...
                            <select name="tipo_aparelho_id" id="tipo_aparelho_id">
								...
								if($arDadosCombo != 0) 
								{
									...
									{
								?>
                                	<option value="<?php echo $dbRowCombo['tipo_aparelho_id'] ?>"><?php echo $ponteiroCombo->imprime($dbRowCombo['nome']) ?></option>
                                <?php
									}
								}
								?>
                        ...
                        <li>
                            ...
                            <select name="marca_id" id="marca_id">
								...
								if($arDadosCombo != 0) 
								{
									...
									{
								?>
                                	<option value="<?php echo $dbRowCombo['marca_id'] ?>"><?php echo $ponteiroCombo->imprime($dbRowCombo['nome']) ?></option>
                                <?php
									}
								}
								?>
