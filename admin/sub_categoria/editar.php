                        ...
                        <li>
                            ...
                            <select name="categoria_id" id="categoria_id">
								...
								if($arDadosCombo != 0) 
								{
									...
									{
								?>
                                	<option value="<?php echo $dbRowCombo['categoria_id'] ?>" <?php echo ($ponteiro->categoria_id == $dbRowCombo['categoria_id'] ? 'selected="selected"':'') ?>><?php echo $ponteiroCombo->imprime($dbRowCombo['nome']) ?></option>
                                <?php
									}
								}
								?>
