...
$ponteiro = new model();
$dbRow = $ponteiro->selectTextos('4');
$titulo = $dbRow['titulo'];

$dbResultC = $ponteiro->selectColaboradores('1');
$dbResultP = $ponteiro->selectProjetos('1');
?>
<!DOCTYPE html>
<html lang="pt-br">
...
<head>
    ...
    <link href="../../css/banner-ensino-infantil.css" rel="stylesheet">   
...
<body>
   ...
   <content>        
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <ul class="list-inline nav-interna-top">
                            ...
                            <li><span class="glyphicon glyphicon-menu-right"></span></li>
                            <li><a href="#" title="ENSINO INFANTIL" class="nav-interna-top-marcada">EDUCAÇÃO INFANTIL</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                    	<ul class="list-unstyled">
                        	<li> 
                            	<div class="infos-ensino-1 pull-left"><span class="glyphicon glyphicon-ok"> </span> MATERNAL I</div>  
                                <div class="infos-ensino-1 pull-left"><span class="glyphicon glyphicon-ok"> </span> MATERNAL II</div>
                            </li>
                            <li> 
                            	<div class="infos-ensino-1 pull-left"><span class="glyphicon glyphicon-ok"> </span> JARDIM I</div>  
                                <div class="infos-ensino-1 pull-left"><span class="glyphicon glyphicon-ok"> </span> JARDIM II</div>
                             </li>
                            <li> 
                            	<div class="infos-ensino-2 pull-left"> <span class="glyphicon glyphicon-time"> </span> Matutino - 8h às 12h</div>  
                                <div class="infos-ensino-2 pull-left"><span class="glyphicon glyphicon-time"> </span> Vespertino - 14h às 18h </div>
                            </li>
        ...
        <div id="banner-sm" class="hidden-md hidden-lg" >            
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-10 col-xs-offset-1 " >
                            <img src="../../imgs/titulo-nosso-ensino-infantil-min.png" alt="Imagem do banner 1 o seu futuro começa aqui."  class="img-responsive "  />
                        </div>
                    </div>
                </div> 
            ...
            <img src="../../imgs/bg-ensino-infantil-min.jpg" class="img-responsive" />
        </div>   
            ...
            <div class="row">
                ...
                ?>
                    <div class="col-xs-6 col-md-3  item-profissional" >                        
                        <img src="../../admin/uploads/r<?php echo $dbRowC['foto'] ?>" alt="<?php echo $dbRowC['nome'] ?>" class="img-responsive" />
